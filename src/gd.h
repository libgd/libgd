...
#define gdImageCreatePalette gdImageCreate
   ...
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromPngCtx(gdIOCtxPtr in);
   BGD_DECLARE(gdImagePtr)
   ...
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromGifCtx(gdIOCtxPtr in);
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromGifPtr(int size, void *data);
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromWBMP(FILE *inFile);
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromWBMPCtx(gdIOCtxPtr infile);
   BGD_DECLARE(gdImagePtr)
   ...
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromJpegCtx(gdIOCtxPtr infile);
   BGD_DECLARE(gdImagePtr)
   ...
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromWebpCtx(gdIOCtxPtr infile);
   ...
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromHeifCtx(gdIOCtxPtr infile);
   ...
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromAvifCtx(gdIOCtxPtr infile);

   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromTiff(FILE *inFile);
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromTiffCtx(gdIOCtxPtr infile);
   BGD_DECLARE(gdImagePtr)
   ...
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromTgaCtx(gdIOCtxPtr ctx);
   BGD_DECLARE(gdImagePtr)
...
*/
   ...
   gdImageCreateFromGd2Part(FILE *in, int srcx, int srcy, int w,
                            int h);
   BGD_DECLARE(gdImagePtr)
   gdImageCreateFromGd2PartCtx(gdIOCtxPtr in, int srcx, int srcy,
                               int w, int h);
   BGD_DECLARE(gdImagePtr)
...
*/
   ...
   BGD_DECLARE(void)
   gdImagePngCtx(gdImagePtr im, gdIOCtxPtr out);
   BGD_DECLARE(void)
   ...
   BGD_DECLARE(void)
   gdImageTiffCtx(gdImagePtr image, gdIOCtxPtr out);
   ...
   BGD_DECLARE(void)
   gdImagePngCtxEx(gdImagePtr im, gdIOCtxPtr out, int level);

   BGD_DECLARE(void)
   gdImageWBMP(gdImagePtr image, int fg, FILE *out);
   BGD_DECLARE(void)
   gdImageWBMPCtx(gdImagePtr image, int fg, gdIOCtxPtr out);
   ...
   BGD_DECLARE(void)
   gdImageJpegCtx(gdImagePtr im, gdIOCtxPtr out, int quality);
   ...
   BGD_DECLARE(void)
   gdImageHeifCtx(gdImagePtr im, gdIOCtxPtr outfile, int quality, gdHeifCodec codec, gdHeifChroma chroma);
 ...
 */
   ...
   BGD_DECLARE(void)
   gdImageGifAnimAddCtx(gdImagePtr im, gdIOCtxPtr out, int LocalCM, int LeftOfs, int TopOfs, int Delay, int Disposal, gdImagePtr previm);
   BGD_DECLARE(void)
   gdImageGifAnimEndCtx(gdIOCtxPtr out);
   BGD_DECLARE(void *)
...
#define gdImageResolutionY(im) (im)->res_y
   ...
   BGD_DECLARE(gdIOCtxPtr)
   gdNewDynamicCtx(int size, void *data);
   ...
   BGD_DECLARE(gdIOCtxPtr)
   gdNewSSCtx(gdSourcePtr in, gdSinkPtr out);
   BGD_DECLARE(void *)
   gdDPExtractData(gdIOCtxPtr ctx, int *size);
...
#define GD_RESOLUTION 96 /* pixels per inch */
   ...
   typedef struct gdPathStruct
   {
      int ref;
      int contours;
      gdPointF start;
      gdArray elements; //gdPathOps
      gdArray points;
   } gdPath;
   ...
   */
   ...
   gdSurfaceCreate(int width, int height, unsigned int type);
   BGD_DECLARE(gdSurfacePtr)
   gdSurfaceCreateForData(unsigned char *data, int width, int height, int stride, unsigned int type);
   BGD_DECLARE(void)
   gdSurfaceDestroy(gdSurfacePtr surface);
   BGD_DECLARE(gdSurfacePtr)
   gdSurfaceAddRef(gdSurfacePtr surface);
   BGD_DECLARE(unsigned char *)
   gdSurfaceGetData(const gdSurfacePtr surface);
   BGD_DECLARE(gdSurfaceType)
   gdSurfaceGetType(const gdSurfacePtr surface);
   BGD_DECLARE(int)
   gdSurfaceGetWidth(const gdSurfacePtr surface);
   BGD_DECLARE(int)
   gdSurfaceGetHeight(const gdSurfacePtr surface);
   BGD_DECLARE(int)
   ...
   BGD_DECLARE(void)
   gdSurfaceWebp(gdSurfacePtr surface, FILE * outFile);
   BGD_DECLARE(void *)
   gdSurfaceWebpPtr (gdSurfacePtr surface, int *size);
   BGD_DECLARE(void *)
   gdSurfaceWebpPtrEx (gdSurfacePtr surface, int *size, int quality);
   BGD_DECLARE(void)
   gdSurfaceWebpEx (gdSurfacePtr surface, FILE * outFile, int quality);
   BGD_DECLARE(void)
   gdSurfaceWebpCtx (gdSurfacePtr surface, gdIOCtx * outfile, int quality);
   BGD_DECLARE(gdSurfacePtr)
   gdSurfaceCreateFromWebpCtx (gdIOCtx * infile);
   BGD_DECLARE(gdSurfacePtr)
   gdSurfaceCreateFromWebp (FILE * inFile);
   BGD_DECLARE(gdSurfacePtr)
